...
/* 0xff31 thru 0xff3f are und=er XK_KOREAN */
 ...
 * function keys;  Sun keyboa=rds and a few other manufactures have such
...
/* * Greek * (based on an early draft o=f, and not quite identical to, ISO/IEC 8859-7)
 * Byte 3 = 7 */
...
/* * Publishing * (these are probably from a= long forgotten DEC Publishing
 * font that once shipped wit=h DECwrite)
 * Byte 3 = 0x0a */
...
/* Hangul Vowel Characters */
 ...
 XK_Hangul_YI                =     0x0ed2
 XK_Hangul_I                 =     0x0ed3
/* Hangul syllable-final (Jon=gSeong) Characters */
...
/* Ancient Hangul Consonant C=haracters */
...
/* Ancient Hangul Vowel Chara=cters */
 XK_Hangul_AraeA             =     0x0ef6
 XK_Hangul_AraeAE            =     0x0ef7
/* Ancient Hangul syllable-fi=nal (JongSeong) Characters */
...
/* those are not really Cauca=sus */
/* For Inupiak */
